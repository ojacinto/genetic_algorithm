...
class Grafo(object):
    ...
    def añadir_aristas_dir(self, vertice1, vertice2, peso=1):
    ...
    def kruskal(self):
        ...
        adjMatrix = []
        for i in range(17):
            adjMatrix.append([1 for i in range(17)])
        ...
        for edge in self.edges:
            ...
            if self.find(vertice1) != self.find(vertice2):
                ...
                # Los vértices por donde pasa el árbol de expansión mínima reciben un incremento de feromona para el algoritmo ACO
                adjMatrix[int(vertice1)-1][int(vertice2)-1] = 10
                adjMatrix[int(vertice2)-1][int(vertice1)-1] = 10
